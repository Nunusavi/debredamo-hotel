...
export default function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative h-[400px] md:h-[500px] bg-navy-900">
        <Image
      ...
      {/* CTA */}
      <PageSection>
        <div className="bg-gradient-to-br from-navy-900 to-navy-800 rounded-2xl p-8 md:p-12 text-white text-center  mx-auto">
