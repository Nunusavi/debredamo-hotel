      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className=" mx-auto text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-navy-100 rounded-full mb-6">
              <Search className="w-10 h-10 text-navy-600" />
            </div>

            <h1 className="text-4xl md:text-5xl font-serif font-bold text-navy-600 mb-4">
              Room Not Found
            </h1>

            <p className="text-lg text-navy-600 mb-8">
              We couldn&apos;t find the room you&apos;re looking for. It may have been
              removed or the link you followed might be incorrect.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className=" mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <h3 className="text-xl font-serif font-bold text-navy-600 group-hover:text-gold-600 transition-colors mb-2">
                  Standard Rooms
                </h3>
