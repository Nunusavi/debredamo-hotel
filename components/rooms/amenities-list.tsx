...
const getAmenityIcon = (amenity: string) => {
  ...
  if (lowerAmenity.includes("air") || lowerAmenity.includes("conditioning"))
    return Wind;
  if (lowerAmenity.includes("tv") && lowerAmenity.includes("smart"))
    return Monitor;
  if (lowerAmenity.includes("tv")) return Tv;
  if (lowerAmenity.includes("coffee") || lowerAmenity.includes("nespresso"))
    return Coffee;
  if (lowerAmenity.includes("bar")) return Coffee;
  if (lowerAmenity.includes("safe")) return Lock;
  if (lowerAmenity.includes("desk") || lowerAmenity.includes("laptop"))
    return Laptop;
  if (lowerAmenity.includes("sitting") || lowerAmenity.includes("armchair"))
    return Armchair;
  if (lowerAmenity.includes("bathtub") || lowerAmenity.includes("jacuzzi"))
    return Bath;
  ...
  if (lowerAmenity.includes("restaurant") || lowerAmenity.includes("dining"))
    return Utensils;
  if (lowerAmenity.includes("robe") || lowerAmenity.includes("slipper"))
    return Shirt;
  if (lowerAmenity.includes("view") || lowerAmenity.includes("city"))
    return Building;
  if (lowerAmenity.includes("balcony") || lowerAmenity.includes("door"))
    return DoorOpen;
  if (lowerAmenity.includes("kitchen") || lowerAmenity.includes("chef"))
    return ChefHat;
  if (lowerAmenity.includes("steam") || lowerAmenity.includes("waves"))
    return Waves;
