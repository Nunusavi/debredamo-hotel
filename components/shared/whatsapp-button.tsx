...
export function EmailButton() {
  ...
  return (
    <a
      href={mailtoUrl}
      className="fixed bottom-6 right-6 z-50 bg-gold-500 hover:bg-gold-600 text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 group"
